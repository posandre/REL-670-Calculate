...
class SettingsDialog(QDialog):
    def __init__(
        ...
        *,
        ...
        self.zone_fill_checkbox = QCheckBox(translator.text("chart.show_zone_fill"))
        self.zone_fill_checkbox.setChecked(show_zone_fill)
        ...
        form.addRow("", self.zone_fill_checkbox)
    ...
    @property
    def show_zone_fill(self) -> bool:
        return self.zone_fill_checkbox.isChecked()
