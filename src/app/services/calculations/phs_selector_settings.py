...
from math import atan, ceil, cos, degrees, pi, sin, sqrt, tan
...
def phs_selector_settings(
    ...
    *,
    ...
    x1_ground_fault = ceil(phs_sensitivity_factor * stage.x1)
    x1_three_phase_q1 = ceil(phs_sensitivity_factor * (stage.x1 * 2.0 / sqrt(3.0)))
    x1_three_phase_q4 = ceil(phs_sensitivity_factor * (
        stage.rfpp
    ...
    if (stage.load_angle_ground_deg or 0.0) > 60.0:
        ...
        rffw_pe = ceil(phs_sensitivity_factor * 2.0 * (
